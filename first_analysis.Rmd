...
return_mean <- sapply(returns_yr[2:22], mean)
return_variance <- sapply(returns_yr[2:22], var)
return_sd <- sapply(returns_yr[2:22], sd)
...
# Calculate covariance of each population
```{r, results = TRUE}
